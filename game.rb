puts "Welcome to the most exciting Math game ever!"
...
loop do
	...
	print 'Do you want to play again? yes to restart or any other response to terminate the game: '
	restart = gets.chomp
